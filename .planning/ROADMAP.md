...
**Plans**: 2 plans
- [x] 05-01-PLAN.md — Storage trait extension + pending_migrations + SqliteStore implementation (backend)
- [x] 05-02-PLAN.md — Restore CLI command + auto-backup before import (frontend)
